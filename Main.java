...
public class Main {
    public static void main(String[] args) {
        ...
        Tutor tut1 = new Tutor("1001022025", "Omar Rincon", "orincon@unal.edu.co"); //Cálculo Diferencial y Álgebra Lineal
        tut1.agregarAsignatura("Cálculo Diferencial");
        tut1.agregarAsignatura("Álgebra Lineal");
        
        Tutor tut2 = new Tutor("1001022026", "Isabela Rodriguez", "irodriguez@unal.edu.co"); //Cálculo Diferencial y Álgebra Lineal
        tut2.agregarAsignatura("Cálculo Diferencial");
        tut2.agregarAsignatura("Álgebra Lineal");
        
        Tutor tut3 = new Tutor("1001022027", "Liseth Ramirez", "lramirez@unal.edu.co");//Programación Básica y Programación Avanzada
        tut3.agregarAsignatura("Programación Básica");
        tut3.agregarAsignatura("Programación Avanzada");
        
        Tutor tut4 = new Tutor("1001022028", "Daniel Zamudio", "dzamudio@unal.edu.co");//Programación Básica y Programación Avanzada
        tut4.agregarAsignatura("Programación Básica");
        tut4.agregarAsignatura("Programación Avanzada");
        
        Tutor tut5 = new Tutor("1001022029", "Jeison Rojas", "jrojas@unal.edu.co");//Fisica I y Fisica II
        ...
        //Arrays con los datos preliminares
        ...
        //Creacion de HashMap de estudiantes por documento
        HashMap<String, Estudiante> estudiantesPorDocumento = new HashMap<>();
        for (Estudiante e: arrayEstudiantes){
            String documento = e.getDocumento();
            estudiantesPorDocumento.put(documento, e);
        }
        
        //Creacion de HashMap de Tutores por asignatura
        ...
        //Creación de HashMap tutorias por estudiante
        ...
        //Creacion de HashMap de historico de tutorias por estudiante
        ...
        //Creacion de HashMap de tutorias pendientes por tutor
        HashMap<String, ArrayMaxHeap> tutoriasPendientes = new HashMap<>();
        for (Tutoria t: arrayTutorias){
            if ("Activa".equals(t.getEstado())){
                //Si aun no está el tutor en el mapa, que lo añada
                //Luego, obtenemos el hashMap y añadimos la tutoria
                if(!tutoriasPendientes.find(t.getIdTutor())){
                    tutoriasPendientes.put(t.getIdTutor(),new ArrayMaxHeap());
                }
                ArrayMaxHeap heap = tutoriasPendientes.get(t.getIdTutor());
                heap.insert(t);
            }
        }
